...
struct sw42000_touch_data {
    ...
    UINT32 reserve1 : 10;
    UINT32 reserve2 : 4;
    UINT32 width_major : 14;
    UINT32 width_minor : 14;
};
#pragma pack()
...
struct sw42000_touch_info {
    UINT32 ic_status;
    UINT32 tc_status;
    UINT32 wakeup_type : 8;
    UINT32 touch_cnt : 5;
    UINT32 button_cnt : 3;
    UINT32 self_recal : 2;
    UINT32 mutual_recal : 2;
    UINT32 abnormal1_recal : 2;
    UINT32 abnormal2_recal : 2;
...
UINT8 cmd_get_irq_info[] = { 0x26, 0x00 };
struct sw42000_touch_info buf;
BOOLEAN
OnInterruptIsr(
...
--*/
{
    ...
    //{
        ...
        //
    SpbDeviceWriteRead(pDevice, cmd_get_irq_info, &buf, sizeof(cmd_get_irq_info), sizeof(buf));
    readReport.DIG_TouchScreenContactCount = (BYTE)buf.touch_cnt;

    // Parse points
    for (UINT8 i = 0; i < buf.touch_cnt; i++) {
        struct sw42000_touch_data* touch_data = &buf.data[i];
        x = touch_data->x;
        y = touch_data->y;
        ...
        readReport.points[i * 6 + 1] = (BYTE)touch_data->track_id;
...
)
{
    ...
    // delay Detected
    WA(0x40, 0x1c, 0x5a, 0x5a, 0x5a, 0x5a);
    WA(0x00, 0x1c);
    WA(0x40, 0x1c, 0xa5, 0xa5, 0xa5, 0xa5);
    WA(0x00, 0x1c);
    WA(0x40, 0x1c, 0xf0, 0xf0, 0xf0, 0xf0);
    WA(0x00, 0x1c);
    WA(0x40, 0x1c, 0x0f, 0x0f, 0x0f, 0x0f);
    WA(0x00, 0x1c);
    WA(0x40, 0x1c, 0x00, 0xff, 0x00, 0xff);
    WA(0x00, 0x1c);
    WA(0x40, 0x1c, 0xff, 0x00, 0xff, 0x00);
    WA(0x00, 0x1c);
    WA(0x40, 0x1c, 0x00, 0x00, 0xff, 0xff);
    WA(0x00, 0x1c);
    WA(0x40, 0x1c, 0xff, 0xff, 0x00, 0x00);
    WA(0x00, 0x1c);
    WA(0x40, 0x1c, 0xff, 0xff, 0xff, 0xff);
    WA(0x00, 0x1c);
    WA(0x40, 0x1c, 0x00, 0x00, 0x00, 0x00);
    WA(0x00, 0x1c);
    WA(0x06, 0x42);
    WA(0x26, 0x44);
    WA(0x26, 0x5b);
    ...
    WA(0x00, 0x5e);
    WA(0x00, 0x1b);
    WA(0x4f, 0xe4, 0x00, 0x00, 0x00, 0x00);
    WA(0x4c, 0x00, 0x01, 0x00, 0x00, 0x00);
    WA(0x4c, 0x01, 0x01, 0x00, 0x00, 0x00);
    WA(0x4f, 0x6a, 0x01, 0x00, 0x00, 0x00);
    WA(0x4f, 0x6d, 0x00, 0x00, 0x00, 0x00);
    WA(0x4f, 0x6f, 0x00, 0x00, 0x00, 0x00);
    WA(0x4f, 0x67, 0x00, 0x00, 0x00, 0x00);
    WA(0x4f, 0x30, 0x00, 0x00, 0x00, 0x00);
    WA(0x4c, 0x03, 0x11, 0x03, 0x00, 0x00);
    WA(0x06, 0x00);
    WA(0x06, 0x01);
    WA(0x0c, 0x00);
    WA(0x4f, 0x30, 0x00, 0x00, 0x00, 0x00);
    ...
    WA(0x06, 0x01);
    WA(0x0c, 0x00);
    WA(0x4f, 0x6f, 0x01, 0x00, 0x00, 0x00);
